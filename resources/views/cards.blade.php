                            ...
                            <div class="card">
                                ...
                                <div class="card-block cards_section_margin">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="card card-primary m-t-35">
                                            ...
                                            <div class="card card-outline-info m-t-35">
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <p class="card-text text-justify">Lorem Ipsum is simply dummy text
                                                        ...
                                                        printing and typesetting industry text of the printing and
                                                        typesetting industry industry text of the printing and
                                        ...
                                        <div class="col-lg-4">
                                            <div class="card card-inverse card-warning m-t-35">
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <p class="card-text"> Lorem Ipsum is simply dummy text of the
                                                        printing and typesetting industry. Lorem Ipsum has been the
                                                        indust's standard dummy text ever since the 1500s,</p>
                                                    <!-- Links -->
                            ...
                            <div class="card m-t-35">
                                ...
                                <div class="card-block cards_section_margin">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="card bd-card card-fade-in m-t-35">
                                                ...
                                                <div class="card-block b_r_5">
                                                    <h4 class="card-title text-white m-t-20"> Card title </h4>
                                                    <p class="card-text">
                                                        Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the indust's
                                        ...
                                        <div class="col-lg-4">
                                            <div class="card swiper_card m-t-35">
                                                ...
                                                <div class="card-img-overlay text-white text-xs-center">
                                                ...
                                                <div class="card-block">
                                                    <article data-spy="scroll" data-target="#scrollspy-nav" data-offset="0" class="scrollspy-example">
                                                        <div class="card card-inverse m-r-15" id="card1">
                                                            ...
                                                            <div class="card-block text-xs-center m-t-15">
                                                                Lorem Ipsum is simply dummy text of the
                                                                printing and typesetting industry. Lorem Ipsum has been the
                                                                indust's standard dummy text ever since the 1500s, when an
                                                                unknown printer.
                                                        ...
                                                        <div class="card card-inverse text-center m-t-20 m-r-15" id="card3">
                                                            ...
                                                            <div class="card-img-overlay">
                                                                <h3 class="card-title text-xs-center">Card3</h3>
                                                            </div>
                                                            <div class="card-block">
                                                        ...
                                                        <div class="card card-inverse text-center m-t-20 m-r-15" id="card4">
                                                            ...
                                                            <div class="card-img-overlay">
                                                                <h3 class="card-title text-xs-center">Card4</h3>
                                                            </div>
                                                            <div class="card-block">
                                                                Tune in next week to find out!
                                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="card card-block m-t-35">
                                                <h4 class="card-title m-t-20">Card title</h4>
                                                <p class="card-text m-t-15 text-justify">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                                                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                                        ...
                                        <div class="col-lg-4 m-t-35">
                                            <div class="card">
                                                <div class="card-header bg-white">
                                                    ...
                                                    <span class="float-xs-right card_refresh">
