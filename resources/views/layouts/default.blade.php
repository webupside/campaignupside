                ...
                <ul id="menu">
                    ...
                    <li {!! (Request::is('index')? 'class="active"':"") !!}>
                        <a href="{{ URL::to('index') }} ">
                            ...
                            <span class="tag tag-pill tag_warnn tag-success new_tag">New</span>
                            </span>
                        </a>
                    </li>
                        ...
                        <ul>
                            ...
                            <li {!! (Request::is('izitoast') ? 'class="active"' : '') !!}>
                                <a href="{{ URL::to('izitoast') }}">
                                    <i class="fa fa-angle-right"></i>
                                    &nbsp; Izi-Toast<span class="tag tag-pill tag_warno tag-success new_tag">New</span>
                                </a>
                            </li>
                            ...
                            <li {!! (Request::is('jstree') ? 'class="active"' : '') !!}>
                                <a href="{{ URL::to('jstree') }}">
                                    <i class="fa fa-angle-right"></i>
                                    &nbsp;Js Tree<span class="tag tag-pill tag_warn tag-success new_tag">New</span>
                                </a>
                            </li>
                            ...
                            <li {!! (Request::is('widgets3')? 'class="active"':"") !!}>
                                <a href="{{URL::to('widgets3')}} ">
                                    ...
                                    <span class="link-title">&nbsp; Widgets 3<span
                                                class="tag tag-pill tag-success new_tag">New</span></span>
                                </a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul>
                            ...
                            <li {!! (Request::is('simple_datatables')? 'class="active"':"") !!}>
                                <a href="{{URL::to('simple_datatables')}} ">
                                    <i class="fa fa-angle-right"></i>
                                    <span class="link-title">&nbsp; Simple Data Tables <span class="tag tag-success tag-pill tag_warn2 new_tag">New</span></span>
                    ...
                    <li {!! (Request::is('calendar')? 'class="active"':"") !!}>
                        <a href="{{ URL::to('calendar') }} ">
                            ...
                            <span class="tag tag-pill tag-success tag_warn1 float-xs-right calendar_tag menu_hide">7</span>
                        </a>
                    </li>
