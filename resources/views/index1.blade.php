                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            <ul class="Browser_stats_ul">
                                <li><span><img alt="google"
                                               src="{{asset('assets/img/chrome.png')}}"/>Google Crome</span><span
                                            class="float-xs-right text-mint">32%<i
                                                class="fa fa-level-up"></i></span>
                                    <hr/>
                                </li>
                                <li><span><img alt="firebox"
                                               src="{{asset('assets/img/firefox.png')}}">Firefox</span><span
                                            ...
                                            <form class="list_of_items">
                                                ...
                                                <div class="todolist_list showactions">
                                                    <div class="col-xs-9 nopad custom_textbox1">
                                                        ...
                                                        <div class="todotext todoitem todo_width strikethrough">Review on Sales
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="todolist_list showactions">
                                                    <div class="col-xs-9 nopad custom_textbox1">
                                                        ...
                                                        <div class="todotext todoitem todo_width strikethrough">Seminar on Market
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-3 float-xs-right showbtnschk showbtns todoitembtns">
                                                        <a href="#" class="todoedit">
