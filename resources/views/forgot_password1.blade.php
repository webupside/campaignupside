        ...
        <div class="col-lg-8 push-lg-2 col-sm-10 push-sm-1">
            <div class="row">
                <div class="col-lg-6 push-lg-3 col-md-8 push-md-2 col-sm-10 push-sm-1 forgotpwd_margin">
                    ...
                    <form action="{{URL::to('forgot_password1')}}" id="login_validator1" method="post"
                        ...
                        <div class="bg-white login_content login_border_radius">
                            ...
                            <div class="form-group form-actions">
                                <a type="submit" class="btn btn-primary submit_email login_button" href="{{URL::to('login1')}}" >Submit
                                </a>
                            </div>
                        </div>
                    </form>
